/*!
	@file     ST7735_LTSM.hpp
	@author   Gavin Lyons
	@brief    Library header file for st7735 display for arduino, Arduino library ST7735_LTSM
...
class ST7735_LTSM: public display16_graphics_LTSM
{
...
public:
	...
	enum TFT_PCBtype_e : uint8_t
	{
		...
		TFT_ST7735S_80160	 /**<  ST7735S 80x160, BOE/HSD panel (buydisplay) */
	};
	...
	void setupGPIO_SPI(uint32_t baudrate, int8_t, int8_t, int8_t);
	void setupGPIO_SPI(uint16_t CommDelay, int8_t, int8_t, int8_t, int8_t, int8_t);
...
private:
	...
	static constexpr uint8_t ST7735_Idle_modeON = 0x39 ; /**< Idle Mode ON */
	static constexpr uint8_t ST7735_Idle_modeOFF = 0x38 ; /**< Idle Mode OFF */
